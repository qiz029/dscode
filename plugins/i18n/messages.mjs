...
export const MESSAGES = {
  en: {
    ...
    'language.set': 'language → {name}', 'language.unknown': 'Unknown language "{value}". Choose en, zh-CN, zh-TW, ja, ko or es.',
  ...
  'zh-CN': {
    ...
    'language.set': '语言 → {name}', 'language.unknown': '未知语言 "{value}"。可选 en、zh-CN、zh-TW、ja、ko、es。',
  ...
  'zh-TW': {
    ...
    'language.set': '語言 → {name}', 'language.unknown': '未知語言 "{value}"。可選 en、zh-CN、zh-TW、ja、ko、es。',
  ...
  ja: {
    ...
    'language.set': '言語 → {name}', 'language.unknown': '不明な言語 "{value}"。en、zh-CN、zh-TW、ja、ko、es から選んでください。',
  ...
  ko: {
    ...
    'language.set': '언어 → {name}', 'language.unknown': '알 수 없는 언어 "{value}". en, zh-CN, zh-TW, ja, ko, es 중에서 선택하세요.',
  ...
  es: {
    ...
    'language.set': 'idioma → {name}', 'language.unknown': 'Idioma desconocido "{value}". Elige en, zh-CN, zh-TW, ja, ko o es.',

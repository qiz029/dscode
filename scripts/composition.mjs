...
export const customPlugins = Object.freeze([
  'openrouter', 'grok', 'opencode-go', 'jev', 'auto-review', 'session-metrics', 'session-cards', 'session-bridge', 'memory', 'time-marks', 'tui-tools', 'email-tools', 'triggers', 'computer-use', 'account',
]);

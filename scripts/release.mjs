...
export async function buildRelease() {
  ...
  const inputs = [
    ...
    { key: 'DEEPSEEK_API_KEY', label: 'DeepSeek API key', description: 'Optional if another provider is configured via /model. Supply locally; never embed credentials in a release.', required: false, secret: true },
  ];

...
// The probe exercises the shipped `standard` preset beside DSCODE's own. Since DSH 0.1.7 the
// preset registry reads declaration rows and the shipped rows live in the `dsh-web-app`
// bundle this profile does not carry, so the overlay declares `standard` from that package's
// own patch file — the exact upstream composition, not a copy maintained here.
const shippedStandardPreset = readFileSync(join(root, 'node_modules/@deepseek-ai/dsh-web-app/presets/standard.patch.yml'), 'utf8');

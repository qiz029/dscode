...
async function main() {
  ...
  const groups = {
    integration: ['verify-session-bridge', 'verify-session-messaging', 'verify-runtime-foundations', 'verify-session-cards', 'verify-memory', 'verify-login-runtime', 'verify-exec', 'verify-triggers', 'verify-trigger-tools'],

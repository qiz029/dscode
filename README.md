...
| [OpenCode Go](docs/opencode-go.md) | Running a session on an OpenCode Go subscription: setup, the models and their reasoning efforts, what is not supported yet |
...
| [Triggers](docs/triggers-design.md) | Why the trigger mechanism is shaped this way: the ingress, the supervised scheduler, the run log as a contract |

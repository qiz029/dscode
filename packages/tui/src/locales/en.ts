...
export const en = {
  ...
  'cmd.delegateDashboard': 'kanban of /delegate tasks: pending, running, verifying, complete',
  ...
  'panel.delegate.name': 'Delegate board',
  'panel.delegate.slots': 'slots',
  'panel.delegate.done': 'done',
  'panel.delegate.close': 'close',
  'panel.delegate.waitingHint': 'child needs the main agent',
  'panel.delegate.refresh': 'live · every second',
  'panel.delegate.high': 'high priority',
  'panel.delegate.after': 'after {ids}',
  'panel.delegate.pending': 'Pending',
  'panel.delegate.running': 'Running',
  'panel.delegate.verifying': 'Verifying',
  'panel.delegate.complete': 'Complete',
  'panel.delegate.more': '+{count} more',
  'panel.delegate.none': 'empty',
  'panel.delegate.empty': 'no delegated tasks yet · start with /delegate <task>',
